...
android {
  namespace = "com.adiraimaji.customkeyboard"
  ...
  sourceSets {
    named("main") {
      ...
      java.srcDirs("srcs/com.adiraimaji.customkeyboard", "vendor/cdict/java/adiraimaji.cdict")
...
val checkKeyboardLayouts by tasks.registering(Exec::class) {
  inputs.dir(projectDir.resolve("srcs/layouts"))
  inputs.file(projectDir.resolve("srcs/com.adiraimaji.customkeyboard/KeyValue.java"))
...
val compileComposeSequences by tasks.registering(Exec::class) {
  ...
  val out = projectDir.resolve("srcs/com.adiraimaji.customkeyboard/ComposeKeyData.java")
  inputs.dir(`in`)
  outputs.file(out)
  doFirst { println("\nGenerating $out") }
